...
const props = defineProps<{
  row: IotNotifyConfigApi.NotifyConfig;
}>();

const emit = defineEmits<{
  click: [row: IotNotifyConfigApi.NotifyConfig];
  debug: [row: IotNotifyConfigApi.NotifyConfig];
  delete: [row: IotNotifyConfigApi.NotifyConfig];
  edit: [row: IotNotifyConfigApi.NotifyConfig];
  history: [row: IotNotifyConfigApi.NotifyConfig];
}>();
